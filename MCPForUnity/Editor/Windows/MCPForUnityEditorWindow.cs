...
namespace MCPForUnity.Editor.Windows
{
    public class MCPForUnityEditorWindow : EditorWindow
    {
        ...
        private McpWorkflowsSection workflowsSection;
        ...
        private ToolbarToggle workflowsTabToggle;
        ...
        private VisualElement workflowsPanel;
        ...
        private bool workflowsLoaded = false;
        ...
        public void CreateGUI()
        {
            ...
            workflowsPanel = rootVisualElement.Q<VisualElement>("workflows-panel");
            ...
            var workflowsContainer = rootVisualElement.Q<VisualElement>("workflows-container");
            ...
            if (clientsPanel == null || workflowsPanel == null || validationPanel == null || advancedPanel == null || toolsPanel == null || resourcesPanel == null)
            {
            ...
            {
                McpLog.Error("Failed to find workflows-container in UXML");
                return;
            }
            ...
            workflowsSection = new McpWorkflowsSection(workflowsContainer);
            if (workflowsTabToggle != null && workflowsTabToggle.value)
            {
        ...
        private void SetupTabs()
        {
            ...
            workflowsTabToggle = rootVisualElement.Q<ToolbarToggle>("workflows-tab");
            ...
            workflowsPanel?.RemoveFromClassList("hidden");
            ...
            if (workflowsTabToggle != null)
            {
                workflowsTabToggle.RegisterValueChangedCallback(evt =>
                {
                    if (evt.newValue) SwitchPanel(ActivePanel.Workflows);
                });
            }
        ...
        private void SwitchPanel(ActivePanel panel)
        {
            ...
            {
                workflowsPanel.style.display = DisplayStyle.None;
            }
            ...
            switch (panel)
            {
                case ActivePanel.Clients:
                    ...
                    clientConfigSection?.RefreshSelectedClient(forceImmediate: true);
                    break;
                case ActivePanel.Workflows:
                    if (workflowsPanel != null) workflowsPanel.style.display = DisplayStyle.Flex;
                    EnsureWorkflowsLoaded();
                    break;
            ...
            workflowsTabToggle?.SetValueWithoutNotify(panel == ActivePanel.Workflows);
        ...
        private void EnsureWorkflowsLoaded()
        {
            if (workflowsLoaded)
            {
                return;
